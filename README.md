...
<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?lines=Web+Developer;AI+Enthusiast;C%2B%2B+Programmer;Lifelong+Learner&font=Fira+Code&weight=500&size=22&duration=2800&pause=900&color=FE428E&center=true&vCenter=true&width=520&height=55" alt="Typing SVG: Web Developer, AI Enthusiast, C++ Programmer, Lifelong Learner"></a>
</p>

# 💫 About Me:
👋 Hi, I'm @vib3withsimran<br>
👀 I enjoy coding<br>
🌱 I'm currently learning web development, AI Engineering, and C++<br>
📫 How to reach me — message me on [LinkedIn](https://www.linkedin.com/in/mssimran/)<br>
😄 Pronouns: she/her
...
- **🤖 [ExplainLikeMyTeacher](https://github.com/vib3withsimran/ExplainLikeMyTeacher)** — an AI-powered mobile learning assistant that explains lecture content the way your favourite teacher would: structured, clear, and calm. Upload notes, ask questions, and visualise concepts as interactive mind maps. `TypeScript`
- **🛡️ [SafeWalk](https://github.com/AyushChoudhary6/safewalk)** — a community-powered safety navigation app that helps users choose safer walking routes using real-time location tracking, crowd-reported incidents, and intelligent route risk analysis. `TypeScript`
- **🧠 [DocPulse-Intelligence](https://github.com/vib3withsimran/DocPulse-Intelligence)** — document intelligence platform powered by HuggingFace sentence-transformers for semantic embeddings and smart retrieval.
- **⚡ [Prompt-improver-extension](https://github.com/vib3withsimran/Prompt-improver-extension)** — a Chrome extension (MV3) that refines your AI prompts, built with React, TypeScript, and Supabase authentication. `TypeScript`
